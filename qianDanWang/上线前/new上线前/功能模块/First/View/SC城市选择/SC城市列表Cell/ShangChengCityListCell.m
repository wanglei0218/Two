...
@interface ShangChengCityListCell ()
...
@implementation ShangChengCityListCell
...
- (void)setCity:(TYDLocationCity *)city {
    if (_city != city) {
        _city = city;
...
-(UILabel *)cityNameLabel{
    if (!_cityNameLabel) {
        ...
        _cityNameLabel.textColor = COLOR_With_Hex(0x222222);
