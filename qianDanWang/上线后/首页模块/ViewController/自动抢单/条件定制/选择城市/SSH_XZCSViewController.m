...
@interface SSH_XZCSViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UITextFieldDelegate>
...
@implementation SSH_XZCSViewController
...
- (void)viewDidLoad {
    ...
    //获取本地存储的城市
    [self.zuiDuoCityArray addObjectsFromArray:[NSKeyedUnarchiver unarchiveObjectWithFile:@"111111"]];
...
-(void)clickQueDingButton{
    ...
    //存储数据
    [NSKeyedArchiver archiveRootObject:self.zuiDuoCityArray toFile:@"111111"];
