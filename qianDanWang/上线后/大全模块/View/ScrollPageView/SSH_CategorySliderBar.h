...
@protocol SSH_CategorySliderBarDelegate <NSObject>

- (void)didSelectedIndex:(NSInteger)index;

@end

//DENGFANGCategorySliderBar
@interface SSH_CategorySliderBar : UIView

@property (nonatomic, strong) NSArray *itemArray;
@property (nonatomic, assign) NSInteger originIndex;
@property (nonatomic, weak) id<SSH_CategorySliderBarDelegate> delegate;
